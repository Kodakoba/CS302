...
- no you may not just "char" to "double" using a static cast.
- it magically handles ```1/0``` without me making an explicit case for it (very cool)
- if you get your ```for``` loop operators backwards you get a funny error from C++ in the linkedList class.
